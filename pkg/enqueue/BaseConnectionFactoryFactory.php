...
class BaseConnectionFactoryFactory
{
    ...
    protected function create(?Dsn $dsn, $config): ConnectionFactory
    {
    ...
    protected function findFactoryClass(Dsn $dsn, array $factories): ?string
    {
